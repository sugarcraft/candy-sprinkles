...
final class Style
{
    ...
    public function inherit(self $parent): self
    {
        ...
        return new self(
            fg:               $has('fg') === true     ? $this->fg               : $parent->fg,
            bg:               $has('bg') === true     ? $this->bg               : $parent->bg,
            fgAdaptive:       $has('fgAdaptive') === true ? $this->fgAdaptive   : $parent->fgAdaptive,
            bgAdaptive:       $has('bgAdaptive') === true ? $this->bgAdaptive   : $parent->bgAdaptive,
            fgComplete:       $has('fgComplete') === true ? $this->fgComplete   : $parent->fgComplete,
            bgComplete:       $has('bgComplete') === true ? $this->bgComplete   : $parent->bgComplete,
            bold:             $has('bold') === true   ? $this->bold             : $parent->bold,
            italic:           $has('italic') === true  ? $this->italic           : $parent->italic,
            underline:        $has('underline') === true ? $this->underline     : $parent->underline,
            strike:           $has('strike') === true  ? $this->strike           : $parent->strike,
            faint:            $has('faint') === true   ? $this->faint            : $parent->faint,
            blink:            $has('blink') === true   ? $this->blink            : $parent->blink,
            reverse:          $has('reverse') === true ? $this->reverse         : $parent->reverse,
            overline:         $has('overline') === true ? $this->overline       : $parent->overline,
            invisible:        $has('invisible') === true ? $this->invisible      : $parent->invisible,
            padding:          $has('padding') === true ? $this->padding         : $parent->padding,
            margin:           $has('margin') === true  ? $this->margin          : $parent->margin,
            width:            $has('width') === true   ? $this->width            : $parent->width,
            height:           $has('height') === true  ? $this->height          : $parent->height,
            maxWidth:         $has('maxWidth') === true ? $this->maxWidth       : $parent->maxWidth,
            maxHeight:        $has('maxHeight') === true ? $this->maxHeight     : $parent->maxHeight,
            alignH:           $has('alignH') === true  ? $this->alignH          : $parent->alignH,
            alignV:           $has('alignV') === true  ? $this->alignV          : $parent->alignV,
            border:           $has('border') === true  ? $this->border          : $parent->border,
            borderSides:      $has('borderSides') === true ? $this->borderSides  : $parent->borderSides,
            borderFg:         $has('borderFg') === true ? $this->borderFg      : $parent->borderFg,
            borderBg:         $has('borderBg') === true ? $this->borderBg      : $parent->borderBg,
            borderSideFg:     $has('borderSideFg') === true ? $this->borderSideFg : $parent->borderSideFg,
            borderSideBg:     $has('borderSideBg') === true ? $this->borderSideBg : $parent->borderSideBg,
            profile:          $has('profile') === true  ? $this->profile        : $parent->profile,
            propsSet:         $this->propsSet,
            inline:           $has('inline') === true  ? $this->inline          : $parent->inline,
            marginBg:         $has('marginBg') === true ? $this->marginBg       : $parent->marginBg,
            colorWhitespace:  $has('colorWhitespace') === true ? $this->colorWhitespace : $parent->colorWhitespace,
            tabWidth:         $has('tabWidth') === true ? $this->tabWidth        : $parent->tabWidth,
            transform:        $has('transform') === true ? $this->transform     : $parent->transform,
            rapidBlink:       $has('rapidBlink') === true ? $this->rapidBlink   : $parent->rapidBlink,
            hyperlink:        $has('hyperlink') === true ? $this->hyperlink     : $parent->hyperlink,
            hyperlinkId:      $has('hyperlink') === true ? $this->hyperlinkId  : $parent->hyperlinkId,
            boundString:      $has('boundString') === true ? $this->boundString  : $parent->boundString,
            underlineColor:   $has('underlineColor') === true ? $this->underlineColor : $parent->underlineColor,
            underlineStyle:  $has('underlineStyle') === true ? $this->underlineStyle : $parent->underlineStyle,
            paddingChar:      $has('paddingChar') === true ? $this->paddingChar : $parent->paddingChar,
            marginChar:       $has('marginChar') === true ? $this->marginChar   : $parent->marginChar,
        );
    }
